...
;(function($) {
    ...
    function updateIndicator(event) {
        ...
        options.indicator.find(options.status).html(options.texts[strength]);
    }
    
    $.fn.pwstrength = function(options) {
        var options = $.extend({
            status: '.status',
            classes: ['pw-sehr-schwach bg-danger', 'pw-schwach bg-danger', 'pw-mittel bg-warning', 'pw-stark bg-success', 'pw-sehr-stark bg-primary'],
